...
export default function NotFound() {
  ...
  return (
    <main style={{
      ...
      padding: isMobile ? '100px 16px 60px' : '24px', 
      position: 'relative', overflow: 'hidden',
    }}>

      {/* bg blobs */}
      <div style={{ position: 'absolute', top: '-120px', right: '-120px', width: isMobile ? '300px' : '500px', height: isMobile ? '300px' : '500px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(35,170,166,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '-80px', left: '-80px', width: isMobile ? '250px' : '380px', height: isMobile ? '250px' : '380px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(38,93,150,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{ maxWidth: '600px', width: '100%', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        >
          {/* Big 404 */}
          <div style={{ position: 'relative', marginBottom: '8px', marginTop: isMobile ? '0px' : '75px' }}>
            <motion.p
              animate={{ y: [0, -10, 0] }}
        ...
        <motion.div
          ...
          style={{ display: 'flex', gap: isMobile ? '8px' : '12px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: isMobile ? '24px' : '32px', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'stretch' : 'center' }}
        >
          {quickLinks.map((link, i) => (
            <Link
              ...
              style={{
                ...
                padding: isMobile ? '14px 22px' : '12px 22px', borderRadius: '12px',
        ...
        >
          <div style={{
            background: 'white', borderRadius: '20px', padding: isMobile ? '20px 20px' : '24px 32px',
